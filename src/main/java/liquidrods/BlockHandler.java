...
/**
 * Implement this interface to provide a new tag. The implementation class should be registered with {@link Liquidrods#registerHandler(String, BlockHandler)}.
 */
public interface BlockHandler {
     ...
     * @param defaultBlockHandler the framework provided default block handler. should be used to render this tag children.
